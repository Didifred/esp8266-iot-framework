...
import { FiRotateCw as Reboot } from "react-icons/fi";
...
export function ControlItem(props) {
  ...
  } else if (props.type == "reboot") {
    return <><Button onClick={(e) => { e.preventDefault(); setTarget(true); save(); fetch(`${props.API}/api/restart`, { method: "POST" }); setTarget(true); }}><Reboot /></Button></>;
  } else {
